...
const menuByPlace = {
  "Anomali Coffee": [
    ...
    { name: "V60 Flores Bajawa", price: 40000, category: "coffee", description: "Kopi manual brew single origin Flores Bajawa dengan profil rasa fruity dan floral.", calories: 3, sugar: 0, ingredients: "Biji kopi Flores Bajawa, air panas" },
    { name: "Flat White", price: 45000, category: "coffee", description: "Kopi susu creamy dengan tekstur mikrofoam lembut.", calories: 120, sugar: 9, ingredients: "Espresso, susu full cream" },
    { name: "Iced Long Black", price: 38000, category: "coffee", description: "Double shot espresso disajikan dingin di atas es.", calories: 5, sugar: 0, ingredients: "Double shot espresso, air, es batu" },
    { name: "Croissant Butter", price: 30000, category: "food", description: "Croissant panggang dengan mentega premium, gurih dan renyah.", calories: 310, sugar: 8, ingredients: "Tepung terigu, mentega, susu, telur" },
    { name: "Brownie Coklat", price: 35000, category: "dessert", description: "Brownie coklat fudgy dengan coklat Belgia.", calories: 380, sugar: 32, ingredients: "Coklat Belgia, mentega, telur, gula" },
  ],
  "Kopi Tuku": [
    { name: "Es Kopi Susu Tuku", price: 24000, category: "coffee", description: "Kopi susu ikonik Tuku dengan gula aren asli.", calories: 190, sugar: 22, ingredients: "Kopi robusta, susu, gula aren" },
    { name: "Kopi Susu Gula Aren", price: 26000, category: "coffee", description: "Kopi susu dengan gula aren, manisnya pas.", calories: 200, sugar: 24, ingredients: "Kopi, susu, gula aren" },
    { name: "Kopi Tubruk", price: 18000, category: "coffee", description: "Kopi tubruk khas Indonesia dengan ampas kopi.", calories: 5, sugar: 0, ingredients: "Bubuk kopi robusta, air panas, gula (opsional)" },
    { name: "Es Teh Tarik", price: 20000, category: "non-coffee", description: "Teh tarik dingin yang creamy dan segar.", calories: 90, sugar: 18, ingredients: "Teh hitam, susu kental manis, es batu" },
    { name: "Pisang Goreng Keju", price: 15000, category: "food", description: "Pisang goreng crispy dengan taburan keju.", calories: 240, sugar: 15, ingredients: "Pisang raja, tepung, keju" },
  ],
  "Nusantara Coffee": [
    { name: "Kopi Kintamani", price: 35000, category: "coffee", description: "Kopi single origin Kintamani dengan rasa citrus segar.", calories: 4, sugar: 0, ingredients: "Biji kopi Kintamani, air panas" },
    { name: "Kopi Robusta Bali", price: 30000, category: "coffee", description: "Kopi robusta Bali yang kuat dan bersahabat.", calories: 4, sugar: 0, ingredients: "Biji kopi robusta Bali, air panas" },
    { name: "Teh Tarik", price: 22000, category: "non-coffee", description: "Teh tarik hangat dengan buih susu yang lembut.", calories: 110, sugar: 20, ingredients: "Teh hitam, susu, gula" },
    { name: "Nasi Campur Bali", price: 45000, category: "food", description: "Nasi campur khas Bali dengan ayam suwir dan sambal matah.", calories: 520, sugar: 6, ingredients: "Nasi, ayam suwir, sambal matah, sayur urap, kacang goreng" },
  ],
  "Tanamera Coffee": [
    { name: "Filter Single Origin", price: 55000, category: "coffee", description: "Kopi filter single origin dengan profil rasa kompleks.", calories: 3, sugar: 0, ingredients: "Biji kopi single origin, air panas" },
    { name: "Espresso", price: 30000, category: "coffee", description: "Shot espresso pekat ala Tanamera.", calories: 3, sugar: 0, ingredients: "Biji kopi espresso, air" },
    { name: "Latte", price: 48000, category: "coffee", description: "Espresso dengan susu steamed yang lembut.", calories: 130, sugar: 10, ingredients: "Espresso, susu full cream" },
    { name: "Iced Long Black", price: 40000, category: "coffee", description: "Espresso dingin segar di atas es.", calories: 5, sugar: 0, ingredients: "Espresso, air, es batu" },
    { name: "Chicken Pesto Sandwich", price: 65000, category: "food", description: "Sandwich roti sourdough dengan ayam pesto.", calories: 450, sugar: 5, ingredients: "Roti sourdough, ayam, saus pesto, sayuran" },
  ],
  "Common Grounds": [
    { name: "Cappuccino", price: 55000, category: "coffee", description: "Espresso, susu steamed, dan buih susu tebal.", calories: 110, sugar: 9, ingredients: "Espresso, susu, microfoam" },
    { name: "Cold Brew", price: 60000, category: "coffee", description: "Kopi seduh dingin 12 jam, smooth dan minim asam.", calories: 5, sugar: 0, ingredients: "Biji kopi, air dingin" },
    { name: "All Day Breakfast", price: 95000, category: "food", description: "Menu sarapan lengkap: telur, roti, sosis, dan kentang.", calories: 650, sugar: 8, ingredients: "Telur, roti panggang, sosis, kentang, salad" },
    { name: "Spaghetti Aglio Olio", price: 85000, category: "food", description: "Spaghetti aglio olio dengan bawang putih dan cabai.", calories: 480, sugar: 4, ingredients: "Spaghetti, bawang putih, minyak zaitun, cabai" },
  ],
  "Folks Coffee": [
    { name: "Kopi Priangan", price: 30000, category: "coffee", description: "Kopi Priangan dengan karakter asam citrus yang segar.", calories: 4, sugar: 0, ingredients: "Biji kopi Priangan, air panas" },
    { name: "Manual Brew", price: 40000, category: "coffee", description: "Kopi manual brew dengan metode pilihan barista.", calories: 4, sugar: 0, ingredients: "Biji kopi pilihan, air panas" },
    { name: "Es Kopi Susu", price: 32000, category: "coffee", description: "Es kopi susu lembut dengan gula aren.", calories: 185, sugar: 21, ingredients: "Kopi, susu, gula aren, es batu" },
    { name: "Sourdough Toast", price: 45000, category: "food", description: "Roti sourdough panggang dengan mentega dan madu.", calories: 330, sugar: 14, ingredients: "Roti sourdough, mentega, madu" },
  ],
};
