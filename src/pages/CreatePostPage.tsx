...
export default function CreatePostPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6 pt-16">
        <div className="glass-card rounded-3xl p-10 text-center max-w-md">
          ...
          <h1 className="text-xl font-black text-foreground mb-2">Masuk untuk membuat postingan</h1>
  ...
  return (
    <div className="pt-24 px-6 md:px-12 max-w-2xl mx-auto pb-20">
      ...
      <h1 className="text-4xl font-black text-foreground mb-8" style={{ fontFamily: "'Fraunces', serif" }}>
        Bagikan Ceritamu
      </h1>

      <form onSubmit={handleSubmit} className="glass-card rounded-3xl p-6 md:p-8 flex flex-col gap-5">
        <div>
        ...
        <div>
          <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Kafe Terkait</label>
        ...
        <div>
          <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Tag (pisahkan dengan koma)</label>
          <input
            value={tagsInput}
        ...
        <div>
          <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Foto</label>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {images.map((img, i) => (
              <div key={i} className="relative h-28 rounded-xl overflow-hidden bg-muted">
